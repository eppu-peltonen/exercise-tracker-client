...
const listOfSports = ['Running', 'Walking', 'Cycling', 'Skiing']
...
const ExampleCustomInput = React.forwardRef(({ value, onClick }, ref) => (
  <button
    type="button"
    className="bg-green-500 hover:bg-green-600 text-gray-100 font-bold px-2 py-1 rounded focus:outline-none focus:shadow-outline"
    onClick={onClick}
    ref={ref}
  >
    {value}
...
const ExerciseForm = ({ createExercise }) => {
  ...
  return (
    <div className="md:w-1/2">
      <form
        onSubmit={(event) => createExerciseObject(event)}
        className="bg-gray-700 border-2 border-gray-500 shadow-md rounded p-8 mb-4"
      >
        <h2 className="text-3xl md:text-4xl mb-3 text-green-400 font-normal">
          Add new exercise
        </h2>
        <div className="mb-6">
          <label
